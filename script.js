// ==========================================
// Windows 11 Boot Screen & Dashboard Redirect
// ==========================================
window.addEventListener('DOMContentLoaded', () => {
    const bootScreen = document.getElementById('bootScreen');
    
    // 1. Keep the bootloader screen visible for 3 seconds
    setTimeout(() => {
        // Smoothly fade out the boot screen overlay
        bootScreen.style.opacity = '0';
        bootScreen.style.visibility = 'hidden';
        
        // 2. Explicitly force redirect display to the main dashboard
